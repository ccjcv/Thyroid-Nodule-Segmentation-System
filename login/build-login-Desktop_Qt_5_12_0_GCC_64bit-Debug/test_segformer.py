...
def fenge():
    ...
    #model_name = 'unet'
    load_path = './quanzhong/segformer_best.pth'
    input_size = 256
    #test_dataset = 'TN3K'
    net = segformer_b2(pretrained=False, num_classes=1)
...
#    save_dir = './results/TN3K/'
    ...
    with torch.no_grad():
        ...
        for sample_batched in tqdm(testloader):
            ...
            total_dsc += dsc
            # hd = cal_HD(prob_pred, labels)
            # total_hd += hd
            # hd_2 = cal_HD_2(prob_pred, labels)
            # total_hd_2 += hd_2
...
#            print(save_path)
    ...
    # print(' hd:' + str(total_hd / len(testloader)))
    # print(' hd_2:' + str(total_hd_2 / len(testloader)))
