...
class UNet_3_1(nn.Module):
    def __init__(self,
        ...
        # #self.dcn_3 = DeformConv2d(inc=256, outc=256, kernel_size=3, padding=0, stride=1, modulation=True)
    ...
    def forward(self, x):
        ...
        x4_channel = self.channel_att_4(x4_jia.contiguous())  # 1#(512,32,32)
