...
class Def_EAmodule(nn.Module):
    def __init__(self, dim=1024):
        ...
        self.Def_Attention = DeformableAttention2D(dim=1024)
        self.eff_att = EfficientAttention(1024)
    ...
    def forward(self, x):
        ...
        return x
class UNet_3_2(nn.Module):
    def __init__(self,
                 n_channels: int = 3,
                 n_classes: int = 2,
                 bilinear: bool = False
                 ):
        super(UNet_3_2, self).__init__()
