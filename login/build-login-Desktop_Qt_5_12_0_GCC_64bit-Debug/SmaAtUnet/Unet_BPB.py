...
class UNet_BPB(nn.Module):
    def __init__(self,
                 n_channels: int = 3,
                 n_classes: int = 2,
                 bilinear: bool = True):
        super(UNet_BPB, self).__init__()
        ...
        self.conv1_1 = nn.Conv2d(512, 1, kernel_size=1)
        self.up_bian = nn.Upsample(scale_factor=16, mode="bilinear", align_corners=True)
    ...
    def forward(self, x):
        ...
        x5_conv1 = self.conv1_1(x5_eff_att)
        x5_bian = self.up_bian(x5_conv1)#用来作监督的
