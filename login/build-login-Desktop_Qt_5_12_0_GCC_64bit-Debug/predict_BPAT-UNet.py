...
from Unet_bot_Transformer.Unet_3_3 import UNet_3_3

def detect_img_BPATUNet(img_path):
...
#    print(img.shape)
    ...
    img = img.to(device)
    model = UNet_3_3(n_classes=1)

    load_path = './quanzhong/BPAT-UNet_best.pth'
...
#    cv2.imwrite("./result_data/single_result.jpg", save_png)
    save_png.save("./result_data/single_result_BPAT-UNet.jpg")
